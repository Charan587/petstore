<?php
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		$query = "INSERT INTO plan (name,email,phone,pet_name,pet_type,date,days)
		 		  VALUES('$name','$email','$phone','$pet_name','$pet_type','$date','$days')";
		$result = mysqli_query($con, $query);
		if ($result) {
			echo ("Plan Done and Dusted");
			header("location:home.php");
		} else {
			echo ("Plan  Failed!...Sheesh");
		}
	}
	?>
  ...
  <head>
    ...
    <style>
        ...
        body {
            ...
            background-image: url('image/plan.jpg'); /* Add the path to your dog image here */
...
<form action="" method="POST">
					<h3>The time and date to leave Your pet here</h3>
						...
						<label for="days">Choose The Days Plan?</label>
						<select id="days" name="days" placeholder="Choose service">
							<option value="1 days - $50">1 days - $50</option>
							<option value="10 days - $350">10 days - $350</option>
							<option value="30 days - $650">30 days - $650</option>
